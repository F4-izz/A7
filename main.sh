...
TIMES="10"
CHATID="5833097176"
KEY="6483756726:AAG98en4NecG8kwVYYqQcTzqh6IYMH7q-rw"
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/F4-RIS/izin/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/F4-RIS/izin/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/F4-RIS/izin/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/F4-RIS/izin/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/F4-RIS/izin/main/ip | grep $ipsaya | awk '{print $3}')
...
wget raw.githubusercontent.com/F4-RIS/x7/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
cd
apt install git -y
git clone https://github.com/F4-RIS/noobzvpn.git
cd noobzvpn/
chmod +x install.sh
./install.sh
...
wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/F4-RIS/x7/main/Enc/encrypt" ; chmod +x /usr/bin/enc
...
wget https://raw.githubusercontent.com/F4-RIS/x7/main/Cfg/m-noobz 
