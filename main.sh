...
TIMES="10"
CHATID="6897997311"
KEY="6692102128:AAEPxKoERgNzWijMrNW3nLpwhMi904yh5Ls"
...
clear;clear;clear
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[96;1m               WELCOME TO SRICPT BY SAERAH              \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/F4-izz/izin/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/F4-izz/izin/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/F4-izz/izin/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/F4-izz/A7/main/"
start=$(date +%s)
secs_to_human() {
...
if [[ $nama = "" ]]; then
echo "SAERAH STORE" > /etc/xray/username
else
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/F4-izz/izin/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/F4-izz/izin/main/ip | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/SaeRah1920"},{"text":"Contack","url":"https://wa.me/6285201197548"}]]}'
...
wget raw.githubusercontent.com/F4-izz/A7/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
print_success "UDP-CUSTOM BY SAERAH STORE VPN"
clear
print_install "MEMASANG NOOBZVPNS"
cd
apt install git -y
git clone https://github.com/F4-izz/noobzvpn.git
cd noobzvpn/
chmod +x install.sh
./install.sh
...
print_success "NOOBZVPNS BY SAERAH STORE"
}
...
wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/F4-izz/A7/main/Enc/encrypt" ; chmod +x /usr/bin/enc
7z x -pas123@Saerah menu.zip
chmod +x menu/*
enc menu/*
...
wget https://raw.githubusercontent.com/F4-izz/A7/main/Cfg/m-noobz 
